    ...
    <>
      ...
      <section className="py-12 md:py-24 px-6 bg-[#2C2C2C]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-stone-300 text-lg mb-4 max-w-2xl mx-auto">
            If you&apos;ve got a question, just send me a message — I&apos;ll get back to you quickly.
          </p>
          <p className="text-stone-400 mb-10 max-w-2xl mx-auto">
            You can WhatsApp or send a quick enquiry, whatever suits you.
          </p>
