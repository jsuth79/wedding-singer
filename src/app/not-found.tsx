      ...
      <section className="py-24 md:py-40 px-6 bg-[#F5F1EB]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/enquiry"
              className="inline-flex flex-col items-center border border-[#2C2C2C] text-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-white px-10 py-4 text-sm tracking-wider transition-colors rounded-[4px]"
            >
